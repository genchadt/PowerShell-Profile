...
function Test-SmtpRelay {
    ...
    switch -Regex ($HOSTNAME) {
        # --- Google ---
        "gmail|google|gsuite" { 
            $HOSTNAME = "smtp.gmail.com"; break 
        }

        # --- Microsoft / Office 365 ---
        # Covers: O365, Outlook, Hotmail, Live, MSN
        "office|o365|outlook|hotmail|live|msn" { 
            $HOSTNAME = "smtp.office365.com"; break 
        }

        # --- Yahoo / Legacy AT&T ---
        # Covers: Yahoo, Ymail, SBCGlobal, ATT.net defaults to Yahoo servers often
        "yahoo|ymail|rocketmail|sbcglobal|att\.net" { 
            $HOSTNAME = "smtp.mail.yahoo.com"; break 
        }

        # --- Apple / iCloud ---
        "icloud|me\.com|mac\.com" { 
            $HOSTNAME = "smtp.mail.me.com"; break 
        }
        ...
        # Spectrum/Charter/TWC is messy, but this is the most common modern endpoint
...
("testsmtp", "testmail", "checksmtp") | ForEach-Object {
